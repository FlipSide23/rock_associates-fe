...
async function countCategories(){
    ...
    let response = await fetch("https://rockassociates-api.herokuapp.com/getProjectByCategory?category=Urban Planning and Development in Rwanda", getData)
    ...
    let response1 = await fetch("https://rockassociates-api.herokuapp.com/getProjectByCategory?category=Design and Supervision of Road Construction Civil Works", getData)
    ...
    let response2 = await fetch("https://rockassociates-api.herokuapp.com/getProjectByCategory?category=Development of the National Policies and Strategies", getData)
    ...
    let response3 = await fetch("https://rockassociates-api.herokuapp.com/getProjectByCategory?category=District Land Use Planning and Physical Planning Elaboration", getData)
    ...
    let response4 = await fetch("https://rockassociates-api.herokuapp.com/getProjectByCategory?category=Car Parking Feasibility Studies and Detailed Engineering Designs", getData)
    ...
    let response5 = await fetch("https://rockassociates-api.herokuapp.com/getProjectByCategory?category=Establishment of Baseline Surveys and District Potentialities Assessment", getData)
    ...
    let response6 = await fetch("https://rockassociates-api.herokuapp.com/getProjectByCategory?category=Sanitary Landfill Feasibility Studies and Detailed Engineering Designs with Environmental and Social Impacts Assessment (ESIA)", getData)
    ...
    let response7 = await fetch("https://rockassociates-api.herokuapp.com/getProjectByCategory?category=Capacity Building, Coaching and Knowledge Transfer on Local Economic Development (LED) for Urban Development Project in Rwanda", getData)
    ...
    //Other
    let response8 = await fetch("https://rockassociates-api.herokuapp.com/getProjectByCategory?category=Other", getData)
